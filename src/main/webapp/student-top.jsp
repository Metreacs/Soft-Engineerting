...
<nav class="site-nav dark js-site-navbar mb-5 site-navbar-target">
    <div class="container">
        <div class="site-navigation">
            <a href="student-home.jsp" class="logo m-0 float-left">四、六级学生考试系统<span class="text-primary">.</span></a>
            ...
            <ul class="js-clone-nav d-none mt-1 d-lg-inline-block site-menu float-right">
                欢迎您：
                <li class="cta-primary"><a href="student-home.jsp"><%=user.getUsername()%></a></li>
