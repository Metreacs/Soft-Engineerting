...
<nav class="site-nav dark js-site-navbar mb-5 site-navbar-target">
    <div class="container">
        <div class="site-navigation">
            <a href="index.jsp" class="logo m-0 float-left">四、六级考试系统<span class="text-primary">.</span></a>
...
<!--
                <li class="has-children">
                    ...
                    <ul class="dropdown">
                        ...
                        <li><a href="elements.jsp" class="nav-link">Elements</a></li>
                        <li class="has-children">
                            <a href="#">Menu Two</a>
                            <ul class="dropdown">
...
-->
            ...
            <ul class="js-clone-nav d-none mt-1 d-lg-inline-block site-menu float-right">
                <li class="cta-button-outline"><a href="login.jsp">登录</a></li>
                <li class="cta-primary"><a href="register.jsp">注册</a></li>
            </ul>
